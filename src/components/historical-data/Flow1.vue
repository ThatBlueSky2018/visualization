...
export default {
  ...
  methods: {
    handleTypeChange(val) {
      this.type = val;
      if (val === "天") {
        this.request_tail = "flow1_day/";
        this.selectedWeek = null; // 选择"天"时，清空周选择器的值
      } else if (val === "周") {
        this.request_tail = "flow1_week/";
    ...
    fetchData() {
      ...
      axios
        ...
        .then((response) => {
          ...
          var chartDom = document.getElementById("flow1_data");
