<template>
  <div id="pumpStatus2">
    <span style="color: black">泵站2</span>
    ...
    />
    <div id="data2">
      <span style="color: black" class="data2_item">频率：{{ frequency }}</span>
      <span style="color: black" class="data2_item"
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      axios
        .get("http://localhost:8000/api/data/pump2_status/")
        .then((response) => {
