<template>
  <div id="pumpStatus4">
    <span style="color: black">泵站4</span>
    ...
    />
    <div id="data4">
      <span style="color: black" class="data4_item">频率：{{ frequency }}</span>
      <span style="color: black" class="data4_item"
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      axios
        .get("http://localhost:8000/api/data/pump4_status/")
        .then((response) => {
